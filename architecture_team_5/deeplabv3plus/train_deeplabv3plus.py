...
- best checkpoint saved to:
    architecture_team_5/deeplabv3plus/runs_deeplabv3plus/best_deeplabv3plus.pt
"""
...
def main():
    ...
    run_dir = os.path.join(THIS_DIR, "runs_deeplabv3plus")
    os.makedirs(run_dir, exist_ok=True)

    best_ckpt = os.path.join(run_dir, "best_deeplabv3plus.pt")
    ...
    print(f"[Info] Best val mean_dice_fg for deeplabv3plus: {best_mean_dice_fg:.4f}")
